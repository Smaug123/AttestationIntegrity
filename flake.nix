{
  description = "Utility for verifying the integrity of NuGet package attestations";
    ...
    in {
      ...
      in {
        ...
        default = pkgs.buildDotnetModule {
          ...
          name = "AttestationIntegrity";
          src = ./.;
          projectFile = "./RepoIntegrity/RepoIntegrity.fsproj";
          testProjectFile = "./RepoIntegrity.Test/RepoIntegrity.Test.fsproj";
